...
<body>
	<div class="page-container">
		<form action="" method="post" class="form form-horizontal" id="form-article-add">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9 ">
					<input type="checkbox" value="1" name="loverStatus">恋人
					<input type="checkbox" value="1" name="friendStatus">朋友
					<input type="checkbox" value="1" name="kinsfolkStatus">亲人
					<input type="checkbox" value="1" name="holidayStatus">节日
				</div>
			</div>
			<div class="row cl" id="stand">
				<label class="form-label col-xs-4 col-sm-2">产品规格：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" name="standardNames" id="" placeholder="名称" value=""
						class="input-text" style="width: 20%">
					<input type="text" name="stocks" id="" placeholder="库存" value=""
						class="input-text" style="width: 20%">
					<input type="text" name="prices" id="" placeholder="单价" value=""
						class="input-text" style="width: 20%">
					<input type="button" id="add_btn" onClick="add()" class="btn" value="添加"/>
				</div>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" name="" id="" placeholder="" value=""
						class="input-text" style="width: 22.6%;border: none">
					<input type="text" name="standardNames" id="" placeholder="名称" value=""
						class="input-text" style="width: 20%">
					<input type="text" name="stocks" id="" placeholder="库存" value=""
						class="input-text" style="width: 20%">
			...
			<div class="row cl">
				<input type="hidden" name="smallPicture" id="smallPicture">
			...
			<div class="row cl">
				<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
					<button	class="btn btn-primary radius" type="button" onClick="addProduct()">
	...
	function addProduct() {
		...
		$.ajax({
			type:"post",
			url:"${pageContext.request.contextPath}/manage/product/saveProduct",
			data:data,
			dataType:"json",
