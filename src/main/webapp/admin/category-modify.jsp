	...
	<form action="" method="post" class="form form-horizontal" id="form-member-add">
		<div class="row cl">
			...
			<div style="margin-left: -30px" class="formControls col-xs-8 col-sm-9">
				<input   name="categoryName" type="text" class="input-text" value="${categorys.categoryName}" placeholder="输入类目名字" id="categoryName">
			</div>
		</div>
		
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
			<input   style="width:80px;height:30px" name="catetory" type="button" value="提交" onclick="modifyCategory()" id="catetory" class="btn btn-primary radius">
			</div>
		</div>
	</form>
</article>
...
function modifyCategory(){
	...
	if(categoryName==null||categoryName.trim()==""){
		...
		$.ajax({
			   url:"${pageContext.request.contextPath}/manage/category/updateCategory?time=" + new Date().getTime(),
			   type:"post", 
			   data:{
